...
class DbSchemaSource extends Map {
	...
	constructor (o) {
		...
		if (o.dir) {
			...
			if (o.root) throw Error (`DbSchemaSource: dir and root cannot be provided together`)

		}
		else {

			let {root, filter} = o; if (!root) throw Error (`DbSchemaSource: either dir or root must be provided`)
